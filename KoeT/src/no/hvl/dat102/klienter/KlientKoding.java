...
public class KlientKoding {
	...
	public static void main(String[] a) {
		...
		String melding = "Dette er en proeve p� en tekst";
		 ...
		 * Tenker oss at sender som koder har en k� og mottaker som dekoder har en k�
		 * K�ene blir operert "synkront" , tar ut og legger inn tilsvarende noekkelelement i de
		 * to k�ene og vi er garantert riktig resultat. Vi g�r ikke rundt alfabetet i
		 *  denne kodingen.
		 */
